...
class part5:
    ...
    Methods:
        1. set_emission_dict() takes emission dict from part 2
        2. __smooth_emission_params() smooth emission params from original dictionary and update to new dictionary
